    ...
    <Container fluid="md my-4 mt-md-5 py-3">
      <Card className="mx-auto py-3" style={{width: "auto"}}>
        <Card.Body style={{width: "auto"}}>
          ...
          <p className="text-md-start ms-2 mt-4 fs-4">
